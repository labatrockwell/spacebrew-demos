...
#define	ELE_CFG			0x5E // Enable electrodes for prox & touch register
...
#define	ATO_CFG0		0x7B // auto-config control register
#define	ATO_CFG1		0x7C // auto-config control register
